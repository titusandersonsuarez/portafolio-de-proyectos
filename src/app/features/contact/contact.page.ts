    ...
    <section class="mx-auto max-w-5xl px-4 py-16">
      ...
      <div class="mt-10 grid gap-8 md:grid-cols-[1fr_1.4fr]">
        ...
        <aside class="space-y-3">
          ...
          <a [href]="info.whatsapp.url" target="_blank" rel="noopener noreferrer"
             class="flex items-center gap-3 p-4 rounded-xl border transition-colors
                    bg-white border-slate-200 hover:border-brand-400
                    dark:bg-slate-900 dark:border-slate-800 dark:hover:border-brand-500">
            <span class="flex-shrink-0 w-9 h-9 rounded-lg flex items-center justify-center
            ...
            <div class="min-w-0">
              <p class="text-xs text-slate-500 dark:text-slate-400">WhatsApp</p>
              <p class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ info.whatsapp.display }}</p>
            </div>
          </a>

          <a [href]="info.instagram.url" target="_blank" rel="noopener noreferrer"
             class="flex items-center gap-3 p-4 rounded-xl border transition-colors
                    bg-white border-slate-200 hover:border-brand-400
                    dark:bg-slate-900 dark:border-slate-800 dark:hover:border-brand-500">
            <span class="flex-shrink-0 w-9 h-9 rounded-lg flex items-center justify-center text-white"
            ...
            <div class="min-w-0">
              ...
              <p class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ info.instagram.handle }}</p>
            </div>
          </a>
